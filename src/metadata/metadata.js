module.exports = {
  ...
  skills: [
  ['TypeScript'], ['React v19'], ['Node JS'], ['CSS'], ['Jest'], ['Figma'],
  ['JavaScript'], ['Angular v21'], ['.NET Core'], ['SASS'], ['Storybook'], ['UX Design'],
  ['HTML'], ['Redux'], ['C#'], ['Material UI'], ['Azure Services'], ['Adobe Suite'],
  ['UI Development'], ['RxJS'], ['SQL'], ['Bootstrap'], ['Sentry'], ['Design Systems']
],
  plays: [
    {
